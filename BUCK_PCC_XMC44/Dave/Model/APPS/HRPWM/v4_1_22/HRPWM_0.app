...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="HRPWM" URI="http://resources/4.1.22/app/HRPWM/0" description="PWM APP using one slice of CCU8 and HRC, with external events, dead time and high resolution positioning support, to generate up to 2 PWM outputs." mode="NOTSHARABLE" version="4.1.22" minDaveVersion="4.3.2" instanceLabel="HRPWM_0" appLabel="" containingProxySignal="true">
  <upwardMapList xsi:type="ResourceModel:RequiredApp" href="../../BUCK_PCC_FIX_FQ/v4_1_4/BUCK_PCC_FIX_FQ_0.app#//@requiredApps.14"/>
  ...
  <virtualSignals name="hrc_clear0" URI="http://resources/4.1.22/app/HRPWM/0/vs_hrpwm_hrc_clear_0" hwSignal="clear_0" hwResource="//@hwResources.1" visible="true">
  ...
  <virtualSignals name="hrc_clear1" URI="http://resources/4.1.22/app/HRPWM/0/vs_hrpwm_hrc_clear_1" hwSignal="clear_1" hwResource="//@hwResources.1"/>
  ...
  <hwResources name="HRC" URI="http://resources/4.1.22/app/HRPWM/0/hwres_hrpwm_hrc" resourceGroupUri="peripheral/hrpwm/*/hrc/*" mResGrpUri="peripheral/hrpwm/*/hrc/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/HRPWM0/HRPWM0_0.dd#//@provided.34"/>
  </hwResources>
  ...
  <connections URI="http://resources/4.1.22/app/HRPWM/0/http://resources/4.1.22/app/HRPWM/0/vs_ccu8_cc8_sta/http://resources/4.1.22/app/HRPWM/0/vs_hrpwm_hrc_clear_0" systemDefined="true" sourceSignal="timer_st1" targetSignal="hrc_clear0" required="false" srcVirtualSignal="//@virtualSignals.9" targetVirtualSignal="//@virtualSignals.20"/>
  ...
  <connections URI="http://resources/4.1.22/app/HRPWM/0/http://resources/4.1.22/app/HRPWM/0/vs_ccu8_cc8_sta/http://resources/4.1.22/app/HRPWM/0/vs_hrpwm_hrc_clear_1" systemDefined="true" sourceSignal="timer_st1" targetSignal="hrc_clear1" srcVirtualSignal="//@virtualSignals.9" targetVirtualSignal="//@virtualSignals.22"/>
